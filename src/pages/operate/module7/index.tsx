...
const TableList: React.FC = () => {
  ...
  //TODO: 修改页面时初始化内容 (首次渲染后,只有第二个参数改变时才会重新渲染)
  // useEffect(() => {
  //   console.log('页面管理article:', props.article);
  //   setHtml(props.article.content);
  //   console.log('html----:', html);
  ...
  const setImgWidth2Html = () => {
    ...
    //TODO: 上传页面之前检查是否有图片, 并设置宽度style="width:100%"
    // 创建一个新的div元素
